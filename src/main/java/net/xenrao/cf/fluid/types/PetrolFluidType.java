package net.xenrao.cf.fluid.types;
...
public class PetrolFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("create_fanta:block/petrol_still");
			private static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation("create_fanta:block/petrol_flow");
