...
public class UnfilteredOrangeJuiceFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("create:fluid/honey_still");
			private static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation("create:fluid/honey_flow");
