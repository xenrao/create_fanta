...
public class CreateFantaModTabs {
	...
	public static final RegistryObject<CreativeModeTab> CREATEFANTA = REGISTRY.register("createfanta",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.create_fanta.createfanta")).icon(() -> new ItemStack(CreateFantaModItems.ORANGE.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(CreateFantaModItems.TESTF_BUCKET.get());
			}).build());
}